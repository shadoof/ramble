...
//let lines = circleLayout(txt, cx, cy, radius, fontSize, ff);
...
ele.innerHTML = lines.reduce((acc, l) => {
  ...
  return acc + `<span class="text" style="top: ${ypos}px; font-size:${l.fontSize}px">${l.text}</span>\n`;
}, '');
